...
public class UIManager : MonoBehaviour
{
    ...
    public void ShowSummaryUI(int score, int hit, int miss, int whip, float accuracy, int highestCombo, float averageReactionTime, float bestReactionTime, int highscore)
    {
        mainGameUI.gameObject.SetActive(false);
        tutorialUI.SetActive(false);
        ...
        summaryUI.UpdateSummary(score, hit, miss, whip, accuracy, highestCombo, averageReactionTime, bestReactionTime, highscore);
    }
